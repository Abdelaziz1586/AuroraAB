...
import static aurora.aurora.AuroraLoggerBungee.logMessage;

public class AuroraLoggerBungeeLog4J implements Filter {
    ...
    public Result filter(LogEvent event) {
        if(logMessage(event.getMessage().getFormattedMessage())) {
            return Result.NEUTRAL;
        }
        return Result.DENY;
    }
